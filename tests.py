...
class TestViews(TestBase):
    ...
    def test_dashboard_view(self):
        ...
        and reidrects to login page then dashboard
        """
    ...
    def test_departments_view(self):
        ...
        and reidrects to login page then to departments page
        """
    ...
    def test_roles_view(self):
        """
        Test that roles page is inaccesible without login and redirects
        to login page thne to roles page
        """
...
class TestErrorPages(TestBase):
    ...
    def test_404_not_found(self):
        response = self.client.get('/nothingthere')
